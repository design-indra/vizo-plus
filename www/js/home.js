...
async function renderHome(container) {
    ...
    container.innerHTML = `
        <section class="hero" id="hero-section" style="height: 40vh; background: linear-gradient(to top, #050505, transparent), url('https://image.tmdb.org/t/p/original/t6SlsTU7c9zSjM0pQM6908vRdb5.jpg'); background-size: cover; background-position: center; display: flex; align-items: flex-end; padding: 20px;">
            <div>
                <h1 style="font-size: 22px;">Avatar: The Way of Water</h1>
                <button class="play-main-btn" onclick="openPlayer('Avatar', '76600')" style="background:#e50914; color:#fff; border:none; padding:8px 15px; border-radius:5px; margin-top:10px;">▶ Putar Sekarang</button>
            </div>
        </section>
        <h3 style="padding:20px 15px 5px 15px; font-size:16px;">Trending Hari Ini</h3>
